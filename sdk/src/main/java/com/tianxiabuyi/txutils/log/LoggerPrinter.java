...
final class LoggerPrinter implements Printer {
    ...
    static final String DEFAULT_TAG = "PRETTY_LOGGER";
     ...
     *
     * @param tag is the given string which will be used in TxLog
     */
    @Override
    ...
    private int getStackOffset(StackTraceElement[] trace) {
        for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
            ...
            if (!name.equals(LoggerPrinter.class.getName()) && !name.equals(TxLog.class.getName())) {
                return --i;
            }
        }
        return -1;
